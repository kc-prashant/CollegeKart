        ...
        <?php if ($listings): ?>
            ...
            <?php foreach ($listings as $l): ?>
                ...
                <div class="card-box">
                    ...
                    <?php
                    $status = $l['transaction_status'] ?? $l['status'];
                    ?>
                    ...
                    <?php if (!empty($l['buyer_name'])): ?>
                        ...
                        <div class="mt-3 p-3 bg-light rounded">
                            ...
                            Email:
                            <?= htmlspecialchars($l['buyer_email']) ?><br>

                            Phone:
                            <?= htmlspecialchars($l['phone'] ?? 'N/A') ?><br>

                            Location:
                            <?= htmlspecialchars($l['location'] ?? 'N/A') ?><br>

                            <?php if ($l['transaction_status'] === 'cancelled'): ?>
